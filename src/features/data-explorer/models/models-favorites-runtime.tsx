...
export default function ModelsFavoritesRuntime({
  ...
  useFavoritesRuntime<ModelsColumnSchema, ModelFavoriteKey, ModelsInfiniteQueryResponse<ModelsColumnSchema[], ModelsLogsMeta>, { cursor: number | null; size: number }, ModelsInfiniteQueryResponse<ModelsColumnSchema[], ModelsLogsMeta>>({
    search,
    isActive,
    session,
    authPending,
