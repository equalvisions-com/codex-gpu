...
const columnSchema = z.object({
  ...
  provider: z.enum(["coreweave", "nebius", "hyperstack", "runpod", "lambda", "digitalocean", "oracle", "crusoe", "flyio", "vultr", "latitude", "ori", "voltagepark", "googlecloud", "verda", "scaleway", "replicate", "thundercompute", "koyeb", "sesterce", "aws", "azure"]),
  source_url: z.string(),
...
const columnFilterSchema = z.object({
  provider: z
    .enum(["coreweave", "nebius", "hyperstack", "runpod", "lambda", "digitalocean", "oracle", "crusoe", "flyio", "vultr", "latitude", "ori", "voltagepark", "googlecloud", "verda", "scaleway", "replicate", "thundercompute", "koyeb", "sesterce", "aws", "azure"])
    .optional(),
  gpu_model: z.string().optional(),
