...
import { gpuColumnOrder, filterFields } from "./constants";
...
import { MobileTopNav } from "./account-components";
    ...
    >
      <div className="flex flex-col gap-2 sm:gap-4">
        ...
        <div className="grid h-full grid-cols-1 gap-0 sm:grid-cols-[13rem_1fr] md:grid-cols-[18rem_1fr]">
          {/* Sidebar Skeleton */}
          <SidebarSkeleton filterFields={filterFields} showSearch={false} currentPage="gpus" />
