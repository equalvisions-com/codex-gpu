...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "data-[can-hover=true]:hover:bg-muted/70 data-[state=selected]:bg-muted border-b transition-colors",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "text-muted-foreground h-[45px] px-2 text-left align-middle font-semibold box-border [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className
    )}
    {...props}
  />
